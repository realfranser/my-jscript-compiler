...
\fbox{%
  \parbox{\textwidth}{
    \begin{tabular}{l|l}
        alert	            &\textless reservedWord, alert \textgreater\\
        boolean	            &\textless reservedWord, boolean \textgreater\\
        else	            &\textless reservedWord, else \textgreater\\
        function	        &\textless reservedWord, function \textgreater\\
        if	                &\textless reservedWord, if \textgreater\\
        input	            &\textless reservedWord, input \textgreater\\
        let	                &\textless reservedWord, let, \textgreater\\
        number	            &\textless reservedWord, number \textgreater\\
        return	            &\textless reservedWord, return \textgreater\\
        string	            &\textless reservedWord, string \textgreater\\
        while	            &\textless reservedWord, while \textgreater\\
        false	            &\textless reservedWord, false \textgreater\\
        true	            &\textless reservedWord, true \textgreater\\
        do	                &\textless reservedWord, do \textgreater\\
        Autoincremento (++) &\textless autoIncOp, autoInc \textgreater\\
        constante entera	&\textless wholeConst, Número\textgreater\\
        Posición(Número)	&\textless chain,  CAdena("c*")\textgreater\\
        Identificador	    &\textless ID, Número\textgreater\\
        =	                &\textless asigOp, equal \textgreater\\
        ,	                &\textless separator, colon \textgreater\\
        ;	                &\textless separator, semicolon\textgreater\\
        (                   &\textless separator,openPar \textgreater\\
        )	                &\textless separator,closePar \textgreater\\
...
\begin{center}
    CASOS DE PRUEBA: Atencion !!!! añadir parse.txt y arbol de vast\\
\end{center}
